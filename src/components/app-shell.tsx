        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6">
          ...
          {showAppNav ? (
            ...
            <nav className="hidden items-center gap-3 md:flex">
              <Link href="/trails" className="text-sm font-medium text-zinc-600 hover:underline dark:text-zinc-300">
                Explore trails
              </Link>
              <Link href="https://github.com/shreyanshjain1/TrailPulse" className="text-sm font-medium text-zinc-600 hover:underline dark:text-zinc-300">
                GitHub
              </Link>
            </nav>
          )}
